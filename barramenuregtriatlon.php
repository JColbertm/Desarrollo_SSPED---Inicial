      ...
      <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="/Desarrollo_SSPED/Triatlon/triatlonindex.php">Triatlon<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Perfil <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="/Desarrollo_SSPED/Triatlon/perfilcouchtriatlon.php">Ver Perfil</a></li>
            <li><a href="/Desarrollo_SSPED/Triatlon/cambiopass1.php">Cambiar Password</a></li>
