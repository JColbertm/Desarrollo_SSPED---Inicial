...
<!--  llamada a la cabecera -->
	<?php 
		require_once $_SERVER["DOCUMENT_ROOT"]."/Desarrollo_SSPED/cabecera3.php";
 	?>
 	<?php 
...
<!--  llamada a lo menu desplegables -->
    <?php 
        require_once $_SERVER["DOCUMENT_ROOT"]."/Desarrollo_SSPED/Ciclismo/opcciclismo.php";
    ?>
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-9 col-sm-3">
                        <a href="/Desarrollo_SSPED/Ciclismo/Semanal/plansemana.php";">
              ...
              <form class="form-horizontal">
                ...
                <div class="col-sm-12 col-xs-12" id="plani">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-9 col-sm-3">
                        <a href="/Desarrollo_SSPED/Ciclismo/Semanal/editadistr.php";">
                          <button  type="button" class="btn btn-primary">
                            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>
                            <span class="hidden-xs">
                              Editar Distri.
