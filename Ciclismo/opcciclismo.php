...
<br><br><br><br>
    ...
    <!--  PRIMERA OPCION (PROGRAMACION) -->
      <div class="panel panel-default">
        ...
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
          <div class="list-group">
                ...
                <a href="/Desarrollo_SSPED/Ciclismo/Programacion/programacion.php">
                ...
                <!--  OPCION DENTRO DE PROGRAMACION (PLANIFICACION DE ENTRENAMIENTOS) -->
                <a href="/Desarrollo_SSPED/Ciclismo/Programacion/planescrito.php">
                <button  type="button" class="list-group-item" data-toggle="tooltip" data-placement="top" title="Planificacion de entrenamientos">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo">
          <h4 class="panel-title">
            <a class="collapsed" role="button" href="/Desarrollo_SSPED/Ciclismo/Semanal/selectatleta.php">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
          <div class="list-group">
            ...
            <a href="/Desarrollo_SSPED/Ciclismo/Atletas/atletas.php">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
          <div class="list-group">
                ...
                <a href="/Desarrollo_SSPED/Ciclismo/Galeria/galeria.php">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="collapsed" role="button" href="/Desarrollo_SSPED/Ciclismo/Teoria/teoriaCiclismo.php">
