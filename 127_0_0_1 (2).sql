...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2016 a las 21:34:51
...
(486, 12, 163, 1, 22.5, 27, 18, 13.5, 9, 90, 0),
(487, 12, 163, 2, 18, 13.5, 22.5, 27, 9, 90, 0),
(488, 12, 164, 3, 22.5, 27, 13.5, 18, 9, 90, 0),
(489, 12, 164, 4, 18, 22.5, 18, 22.5, 9, 90, 0),
...
(533, 16, 179, 3, 31.5, 42, 63, 52.5, 21, 210, 0),
...
CREATE TABLE `evaluacion` (
  ...
  `total_ana` float NOT NULL,
  `evag_1` varchar(2) NOT NULL,
  `evag_2` varchar(2) NOT NULL,
  `total_glob` float DEFAULT NULL,
  `evaf_1` varchar(2) DEFAULT NULL,
  `evaf_2` varchar(2) DEFAULT NULL,
  `total_fis` float DEFAULT NULL,
  `tot_no` float NOT NULL,
  `tot_lit` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(24, 'CTLP', 1, '2016-05-12', '0000-00-00', 1, 1),
...
INSERT INTO `jugador` (`idJugador`, `nombre_ju`, `apellidop_ju`, `apellidom_ju`, `fechana_ju`, `imagen_ju`, `estado_ju`, `idGrupo`, `idEntrenador`) VALUES
(39, 'Diego', 'Alvarez', 'Camacho', '2000-04-05', 'fotos/EjercicioFutbol.png', 1, 23, 0),
(40, 'Orlando', 'Valdez', 'Sanchez', '1993-04-03', 'fotos/EjercicioFutbol.png', 1, 24, 0),
(41, 'Javier', 'Colbert', 'Martinez', '1999-02-01', 'fotos/EjercicioFutbol.png', 1, 24, 0);
...
INSERT INTO `mesociclo` (`idMesociclo`, `idPlanificacion`, `idPlanificacion_etapa`, `ciclo`, `semanas`) VALUES
(163, 12, 1, 1, 2),
(164, 12, 2, 2, 3),
(165, 12, 3, 3, 3),
(166, 12, 4, 4, 3),
...
--
ALTER TABLE `categoria_grupo`
  MODIFY `idCategoria_grupo` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `direccion`
  MODIFY `idDireccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=542;
--
-- AUTO_INCREMENT de la tabla `ejercicio`
--
ALTER TABLE `ejercicio`
  MODIFY `idEjercicio` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
--
...
--
ALTER TABLE `entrenador`
  MODIFY `idEntrenador` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `evaluacion`
--
ALTER TABLE `evaluacion`
  MODIFY `idEvaluacion` int(4) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `grupo`
  MODIFY `idGrupo` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT de la tabla `informacion`
--
ALTER TABLE `informacion`
  MODIFY `idInformacion` int(4) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jugador`
--
ALTER TABLE `jugador`
  MODIFY `idJugador` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT de la tabla `mesociclo`
--
ALTER TABLE `mesociclo`
  MODIFY `idMesociclo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
--
...
--
ALTER TABLE `planificacion`
  MODIFY `idPlanificacion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de la tabla `planificacion_etapa`
--
ALTER TABLE `planificacion_etapa`
  MODIFY `idPlanificacion_etapa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
--
-- AUTO_INCREMENT de la tabla `planificacion_periodo`
--
ALTER TABLE `planificacion_periodo`
  MODIFY `idPlanificacion_periodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
-- AUTO_INCREMENT de la tabla `programacion`
--
ALTER TABLE `programacion`
  MODIFY `idProgramacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
--
...
--
ALTER TABLE `asistencia`
  ADD CONSTRAINT `asistencia_ibfk_1` FOREIGN KEY (`idClase`) REFERENCES `clases` (`idClase`),
  ADD CONSTRAINT `asistencia_ibfk_2` FOREIGN KEY (`idJugador`) REFERENCES `jugador` (`idJugador`);
...
--
ALTER TABLE `evaluacion`
  ADD CONSTRAINT `evaluacion_ibfk_1` FOREIGN KEY (`idAsistencia`) REFERENCES `asistencia` (`idAsistencia`);
