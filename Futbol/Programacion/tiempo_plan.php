    ...
    <div class="tab-content">
      ...
      <br>
        ...
        <br>
           ...
           echo "<input type='hidden' id='sem' value='".$s."'>
            ...
            ?>
              ...
              <div class="col-xs-12">
                ...
                <div class="col-sm-10">
                  <input type="text" value="" placeholder="Planificacion" class="form-control" name="nombrePlanificacion" style="width: 300px;" required="">
                </div>
              </div>
          ...
          <div class="col-sm-12">
            <br><br>                   
              <label class="col-sm-offset-2 col-sm-2">Transito:</label> 
